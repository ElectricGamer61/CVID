...
// basepath follows Vite's --base so FreeCut can be mounted under /editor when embedded
// same-origin inside Cvideo. Standalone (base "/") -> "" -> default, so nothing changes.
const routerBasepath = import.meta.env.BASE_URL.replace(/\/+$/, '')
const router = createRouter({ routeTree, basepath: routerBasepath || undefined })
